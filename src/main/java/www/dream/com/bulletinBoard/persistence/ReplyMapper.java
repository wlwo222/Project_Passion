...
public interface ReplyMapper {
	...
	public List<ReplyVO> findReviewListById(@Param("productId") String productId);
	
	public ReplyVO findReviewByReplyId(@Param("replyId") String replyId);
	
	public int insertReview(ReplyVO riview);
	
	public int updateReview(ReplyVO riview);
	
	public int deleteReviewByReplyId(@Param("replyId") String replyId);
	...
	/** id 값으로 Post 객체 조회 */
	public int insertReply(@Param("productId") String productId, @Param("reply") ReplyVO reply);
	/** 댓글 수정 처리 */
