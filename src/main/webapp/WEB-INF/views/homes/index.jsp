					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian">
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian"
											href="#consultation"> <span class="badge pull-right"><i
												class="fa fa-plus"></i></span> Consultation
										</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#hat">
								...
								<div id="outer" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											...
											<li><a href="#">hoodzipup</a></li>
											<li><a href="#">in-betweenseasonscoat</a></li>
											<li><a href="#">jacket</a></li>
											<li><a href="#">otherouter</a></li>
											<li><a href="#">wintercoat</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default">
								...
								<div id="shoes" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#">sandals,slippers,boots</a></li>
													...
													<div class="popup3" id="pop3">
														...
														<div class="content">
															<div class="product-detail">
																			...
																			<tr>
																				...
																				<td><select option_product_no="6940"	option_select_element="ec-option-select-finder"
																					...
																					required="true">
																						...
																						<c:set var="productOrgName" value="${fn:split(pdAddInfo[5].description, '_')}"></c:set>
																							<c:if test="${fn : contains(product.productName, productOrgName)}">
																								<option value="${productOrgName[1]}">
																							</c:if>
																						</c:forEach>
																				</select>
																					<p class="value"></p></td>
																...
																<p
																	class="ec-base-help txt11 displaynone EC-price-warning"></p>
															</div>
														</div>
														<div
