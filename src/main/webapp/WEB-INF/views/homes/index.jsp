				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian">
							<!--category-productsr-->
							<c:forEach items="${upperCategories}" var="upperCategory" varStatus="status">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian"
											href="#consultation"> <span class="badge pull-right"><i
												class="fa fa-plus"></i></span> ${upperCategory.categoryName}
										</a>
									</h4>
								</div>
								<div id="${upperCategory.categoryName}" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
										<c:forEach items="${subCategories}" var="upperCategory" varStatus="status">
