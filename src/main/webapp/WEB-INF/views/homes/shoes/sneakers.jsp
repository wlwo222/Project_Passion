						...
						<div class="panel-group category-products" id="accordian">
								...
								<div id="outer" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											...
											<li><a href="/homes/outer/seasonscoat">seasonscoat</a></li>
							...
							<div class="panel panel-default">
								...
								<div id="shoes" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="/homes/shoes/sandalsslippersboots">sandals,slippers,boots</a></li>
...
<!-- ################################################################################Product Start################################################################################ -->
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items">
						...
						<c:forEach items="${sneakers}" var="product" varStatus="status">
						<!-- ProductVO -->
